...
public class MyConfiguration extends JPanel implements ActionListener {
	final private static String PROPFILE= "Application.properties";
	final private static String[] attributes = new String[] {"user.name", "user.password", "log_level", 
		"format.date", "format.dateAndTime"
	};
	...
	public static MyConfiguration getInstance() {
		if(instance == null)
			instance = new MyConfiguration(3);
